...
namespace Microsoft.AspNetCore.Mvc.Razor
{
    ...
    public class CustomRazorViewEngine : IRazorViewEngine
    {
        ...
        public static string GetNormalizedRouteValue(ActionContext context, string key)
            => CustomNormalizedRouteValue.GetNormalizedRouteValue(context, key);
        ...
        public RazorPageResult FindPage(ActionContext context, string pageName)
        {
            ...
            {
                throw new ArgumentException("argument can not be null or empty", nameof(pageName));
            }
        ...
        public RazorPageResult GetPage(string executingFilePath, string pagePath)
        {
            ...
            {
                throw new ArgumentException("argument can not be null or empty", nameof(pagePath));
            }
        ...
        public ViewEngineResult FindView(ActionContext context, string viewName, bool isMainPage)
        {
            ...
            {
                throw new ArgumentException("argument can not be null or empty", nameof(viewName));
            }
        ...
        public ViewEngineResult GetView(string executingFilePath, string viewPath, bool isMainPage)
        {
            ...
            {
                throw new ArgumentException("argument can not be null or empty", nameof(viewPath));
            }
        ...
        public string GetAbsolutePath(string executingFilePath, string pagePath)
        {
            ...
            if (string.IsNullOrEmpty(executingFilePath))
            {
                ...
                return CustomViewEnginePath.ResolvePath(absolutePath);
            }

            return CustomViewEnginePath.CombinePath(executingFilePath, pagePath);
        }
        ...
        internal CustomViewLocationCacheResult CreateCacheResult(
            ...
            bool isMainPage)
        {
            ...
            if (factoryResult.Success)
            {
                ...
                var viewStartPages = isMainPage ?
                    ...
                    Array.Empty<CustomViewLocationCacheItem>();

                return new CustomViewLocationCacheResult(
                    new CustomViewLocationCacheItem(factoryResult.RazorPageFactory, relativePath),
                    viewStartPages);
            }
        ...
        private IReadOnlyList<CustomViewLocationCacheItem> GetViewStartPages(
            string path,
            HashSet<IChangeToken> expirationTokens)
        {
            var viewStartPages = new List<CustomViewLocationCacheItem>();

            foreach (var filePath in CustomRazorFileHierarchy.GetViewStartPaths(path))
            {
                ...
                if (result.Success)
                {
                    ...
                    viewStartPages.Insert(0, new CustomViewLocationCacheItem(result.RazorPageFactory, filePath));
                }
            }
        ...
        private ViewEngineResult CreateViewEngineResult(CustomViewLocationCacheResult result, string viewName)
        {
            if (!result.Success)
            {
