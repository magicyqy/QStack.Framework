...
namespace Microsoft.AspNetCore.Mvc.Razor
{
    ...
    /// </summary>
    internal readonly struct CustomViewLocationCacheKey : IEquatable<CustomViewLocationCacheKey>
    {
        /// <summary>
        ...
        public CustomViewLocationCacheKey(
            string viewName,
            bool isMainPage)
            : this(
                  viewName,
        ...
        /// <inheritdoc />
        public bool Equals(CustomViewLocationCacheKey y)
        {
        ...
        {
            if (obj is CustomViewLocationCacheKey)
            {
                return Equals((CustomViewLocationCacheKey)obj);
            }
