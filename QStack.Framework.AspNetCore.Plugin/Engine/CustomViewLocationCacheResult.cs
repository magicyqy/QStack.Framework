...
namespace Microsoft.AspNetCore.Mvc.Razor
{
    ...
    /// </summary>
    internal class CustomViewLocationCacheResult
    {
        /// <summary>
        ...
        public CustomViewLocationCacheResult(
            CustomViewLocationCacheItem view,
            IReadOnlyList<CustomViewLocationCacheItem> viewStarts)
        {
            if (viewStarts == null)
            {
        ...
        public CustomViewLocationCacheResult(IEnumerable<string> searchedLocations)
        {
        ...
        public CustomViewLocationCacheItem ViewEntry { get; }

        /// <summary>
        /// <see cref="ViewLocationCacheItem"/>s for applicable _ViewStarts.
        /// </summary>
        /// <remarks><c>null</c> if <see cref="Success"/> is <c>false</c>.</remarks>
        public IReadOnlyList<CustomViewLocationCacheItem> ViewStartEntries { get; }
