...
{
    internal class CustomCSharpCompiler
    {
        private readonly CustomRazorReferenceManager _referenceManager;
        ...
        public CustomCSharpCompiler(CustomRazorReferenceManager manager, IWebHostEnvironment hostingEnvironment)
        {
            ...
            else
            {
                ...
                switch (dependencyContextOptions.DebugType.ToLower())
                {
                    ...
                    case "pdbonly":
                        ...
                        break;
                    default:
                        throw new InvalidOperationException($"Format Unsupported Debug Information Format {dependencyContextOptions.DebugType}");
                }
            }
