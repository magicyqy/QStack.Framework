...
namespace QStack.Framework.Util
{
    ...
    {
        public static string ToMd516String(this Expression expression)
        {
            return ToExpressionString(expression).ToMd5Fingerprint();
        }
        /// <summary>
        ...
        public static string ToExpressionString(this Expression expression)
        {
            ...
            expression = Evaluator.PartialEval(expression, ExpressionExtension.CanBeEvaluatedLocally);
    ...
    public static class Evaluator
    {
        ...
        class SubtreeEvaluator : ExpressionVisitor
        {
            ...
            private Expression Evaluate(Expression e)
            {
                ...
                var s =Expression.Constant(fn.DynamicInvoke(null), e.Type);
                return s;
            }
