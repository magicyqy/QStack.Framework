   ...
   public  class AutoStringToNumberConverter: JsonConverter<object>
    {
        ...
        public override object Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            if (reader.TokenType == JsonTokenType.String)
            {
                ...
                return int.TryParse(s, NumberStyles.Integer, NumberFormatInfo.InvariantInfo, out var i) ?
                    i :
                    (double.TryParse(s, NumberStyles.Float, NumberFormatInfo.InvariantInfo, out var d) ?
                        d :
