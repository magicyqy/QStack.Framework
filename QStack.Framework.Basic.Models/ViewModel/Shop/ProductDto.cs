...
namespace QStack.Framework.Basic.ViewModel.Shop
{
    ...
    public  class ProductDto :BaseDto
    {
       ...
       public virtual string Name { get; set; }
        ...
        public virtual IList<ProductCategoryTagDto> ProductTags { get; set; }
       
        public virtual IList<ProductImageDto> ProductImages { get; set; }
        public virtual IList<ProductDownloadDto> ProductDownloads { get; set; }
    }
