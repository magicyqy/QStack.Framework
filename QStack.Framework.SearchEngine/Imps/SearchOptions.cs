    ...
    public class SearchOptions
    {
        ...
        public SearchOptions(string keywords, string[] fields, int maximumNumberOfHits = 10000, Dictionary<string, float> boosts = null, Type type = null, string[] orderBy = null, int? skip = null, int? take = null)
        {
            ...
            if (fields!=null)
            {
                ...
                Fields.AddRange(fields.Select(f=>f.RemoveCharacters(" ")));
            }
            ...
            if (orderBy!=null)
            {
                ...
                OrderBy.AddRange(orderBy.Select(f => f.RemoveCharacters(" ")));
            }
        }
        ...
        public SearchOptions(string keywords, int page, int size, Type t) : this(keywords, t.GetProperties().Select(p => p.Name).ToArray(), int.MaxValue, null, null, null, (page - 1) * size, size)
        {
            if (page < 1)
            {
                page = 1;
