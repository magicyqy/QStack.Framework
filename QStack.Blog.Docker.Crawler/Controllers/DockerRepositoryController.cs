...
namespace QStack.Blog.Docker.Crawler.Controllers
{
	...
	public class DockerRepositoryController : Controller
	{
		...
		public DockerRepositoryController(IDockerCrawlerService dockerCrawlerService)
		{
		...
		//public async Task<IActionResult> Add(DockerRepositoryDto dto)
		//{
		...
		//	if (await _dockerCrawlerService.AnyRepository(x => x.Name == dto.Name.Trim()))
		//	{
		...
		//	if (await _dockerCrawlerService.AnyRepository(x =>
		...
		//	var repository = new DockerRepositoryDto
		//	{
		//		Name = dto.Name,
		//		Schema = schema,
		//		Registry = registry,
		...
		//	};
		//	await _dockerCrawlerService.AddRepository(repository);
		...
		//	if (await _dockerCrawlerService.AnyRepository(x => x.Id == id))
		//	{
		//		await _dockerCrawlerService.DeleteRepository(id);
		...
		//{
		//	var list = await _dockerCrawlerService.GetRepositories();
		//	return View(list);
		//}
