...
namespace QStack.Framework.Persistent.EFCore
{
    public static class DbContextExtentions
    {
        ...
        public static async Task<IEnumerable<T>> SqlQuery<T>(this DatabaseFacade facade, string sql, params object[] parameters) where T : class, new()
        {
            DataTable dt =await SqlQuery(facade, sql, parameters);
